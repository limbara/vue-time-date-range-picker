...
describe("Calendar : Changing Page", () => {
  ...
  it("should show prev calendar page", () => {
    ...
    const monthYear = moment(now).subtract(1, "M").format("MMM YYYY");
  ...
  it("should show next calendar page", () => {
    ...
    const monthYear = moment(now).add(1, "M").format("MMM YYYY");
  ...
  it("should show prev calendar page with initialized dates", () => {
    ...
    const monthYear = moment(startDate).subtract(1, "M").format("MMM YYYY");
  ...
  it("should show next calendar page with initialized dates", () => {
    ...
    const monthYear = moment(startDate).add(1, "M").format("MMM YYYY");
