...
```html
<head>
  <link rel="stylesheet" href="https://unpkg.com/vue-time-date-range-picker@2.1.0/dist/vdprDatePicker.min.css">
</head>`
<body>
  <div id="app">
  ...
  <script src="https://unpkg.com/vue-time-date-range-picker@2.1.0/dist/vdprDatePicker.js"></script>
  <script>
